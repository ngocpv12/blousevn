...
export class AuthenticationService {
  ...
  login(userData) {
    return this._http.post<any>(this._url + 'login', userData, {observe: 'response'})
      .pipe(catchError(this.errorHandler));
  }

  loginWithGoogle(name, email){
    return this._http.post<any>(this._url + 'oauth/google', {name: name, email: email}, {observe: 'response'})
    .pipe(catchError(this.errorHandler));
  }
